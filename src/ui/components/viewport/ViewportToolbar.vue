  ...
  <div class="viewport__controls">
    ...
    <div class="viewport__controls-row">
      ...
      <div class="viewport__display-modes">
        ...
        >
          ...
          >
            <path
              d="M2 2L14 2M2 2L2 14M14 2L14 14M2 14L14 14"
              stroke="currentColor"
              stroke-width="1.5"
              fill="none"
            />
            <path
              d="M2 8L14 8M8 2L8 14"
              stroke="currentColor"
              stroke-width="1"
              stroke-opacity="0.5"
              fill="none"
        ...
        >
          ...
          >
            ...
            <path
              d="M4 4L12 4M4 4L4 12M12 4L12 12M4 12L12 12"
              stroke="currentColor"
              stroke-width="1"
              stroke-opacity="0.3"
              fill="none"
    ...
    <div class="viewport__display-modes viewport__display-modes--separated">
      ...
      >
        ...
        >
          <path
            d="M2 11C2 7 4 4 8 4C12 4 14 7 14 11"
            stroke="currentColor"
            stroke-width="1.5"
